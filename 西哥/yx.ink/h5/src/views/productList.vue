<template>
    <div class="tem">
        <van-nav-bar fixed :title="title" left-arrow @click-left="$back()"></van-nav-bar>
        <div class="box-2">
...
export default {
    ...
    computed:{
        ...
        title(){
            return this.goodsType.find(x=>x.id==this.query.goodsType) ? this.goodsType.find(x=>x.id==this.query.goodsType).title : ''
        }
    },
    filters:{
        qian(number){
