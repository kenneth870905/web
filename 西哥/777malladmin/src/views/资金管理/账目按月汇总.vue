<template>
    <div>
        <div class="header-1">
            ...
            <el-input class="r15" style="width: 150px;" v-model="代理" size="mini" placeholder="代理账号"></el-input>
            <el-button type size="mini">查询</el-button>
            <el-button type size="mini">图形报表</el-button>
        </div>
        
        <el-table :data="list" border stripe size="mini">
            <el-table-column label="日期"></el-table-column>
            <el-table-column label="公司入款"></el-table-column>
            <el-table-column label="在线充值" prop="money"></el-table-column>
            <el-table-column label="公司出款"></el-table-column>
            <el-table-column label="手动存款"></el-table-column>
