<template>
    <div>
        ...
        <div class="title2">
            ...
            <el-date-picker style="width: 250px;margin-left:10px;" value-format="yyyy-MM-dd" @change="changeTime3" size="mini" v-model="time3" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
            ...
            <el-table :data="list" border size="small" stripe>
                    ...
                    <template slot-scope="scope">
                        <div class="商品列表">
                            ...
                            <div v-for="item in scope.row.items">
                                ...
                                <span class="规格">{{item.productAttribute.color}}，{{item.productAttribute.size}}</span>
                ...
                <el-table-column label="收货地址" width="80px" align="center" prop="comment">
                    <template slot-scope="scope">
                        ...
                        <el-button v-else @click="获取收货地址(scope.row)" type="text">查看</el-button>
                    </template>
                </el-table-column>
