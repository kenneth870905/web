<template>
    <div >
        ...
        <div ref="mui_content" class="mui-content mui-fullscreen" @scroll="scroll_1($event)" style="background-image:url('image/index/bg.jpg'); 
    top: 0;
    right: 0;
    bottom: 0;
    left: 0;
...
.list_2 li {
    ...
    padding: 3px;
    background: white;
    box-shadow: 1px 0px 3px 0px #171111;
}
.list_2 .img_box {
    width: 26px;
    height: 26px;
