<template>
    <div class="agency" style="background-color: #efeff4;" >
        <div class="agency_title" @click="$router.back()">
            <header class="mui-bar mui-bar-nav">
                <a class=" mui-icon mui-icon-left-nav mui-pull-left" style="color:#fff"></a>
...
.agency_title {
    background-image: url('/image/daili/agent-bj.png');
    height: _vw(160);
    width: 100%;
