    ...
    <div  style="background-image:url('image/index/bg.jpg'); 
        ...
        <div class="mui-content mui-fullscreen">
            ...
            <div>
                ...
                <div class="添加" @click="$router.push('/yhk')" v-else-if="!info.IsBank || !info.IsQkPwd">
                ...
                <div v-else>
                    <ul class="list mui-table-view">
                        ...
                        <li class="mui-table-view-cell item">
                            <label>银行卡</label>
                            <div class="绿色">{{info.Bank + '('+info.Name+')'}}</div>
                        </li>
                        <li class="mui-table-view-cell title">
                            提交审核(每日取款{{config.tk ? config.tk : 5}}次后，会额外收费)			
                        </li>
                        <li class="mui-table-view-cell item">
                            <label>当前打码量</label>
                        ...
                        <li class="mui-table-view-cell item">
                            <label>取款金额</label>
                            <input type="text" v-model="amount" placeholder="100起提" >
                            <span>￥</span>
                        </li>
                        <li class="mui-table-view-cell item">
                            <label>安全密码</label>
                            <input type="password" v-model="pwd" maxlength="4" placeholder="请输入4位安全密码">
                        </li>
                        <li class="mui-table-view-cell item">
                            <label>预计到账</label>
...
export default {
    ...
    methods: {
        ...
        提现(){
            ...
            mui.confirm('确定提交取款审核吗？<br>金额：' + this.amount, '确认', ['否', '是'], (e)=>{
                if (e.index == 1) {
                    this.加载中(true)
