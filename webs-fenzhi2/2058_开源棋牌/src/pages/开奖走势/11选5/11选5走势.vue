<template>
    <div class="走势内容">
        <div class="头部">
            <ul class="title_1">
                <li :class="{'active':走势查看==0}" @tap="查看类型(0)">万位走势</li>
                <li :class="{'active':走势查看==1}" @tap="查看类型(1)">千位走势</li>
                <li :class="{'active':走势查看==2}" @tap="查看类型(2)">百位走势</li>
                <li :class="{'active':走势查看==3}" @tap="查看类型(3)">十位走势</li>
            </ul>
            <!-- <ul class="走势列表">
                <li class="header">
                    <div class="期数">期号</div>
