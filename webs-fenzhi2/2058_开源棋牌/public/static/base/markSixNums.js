(function ($) {
    ...
    var wuxj = ["05", "06", "19", "20", "27", "28", "35", "36", "49"];    //金
    var wuxm = ["01", "02", "09", "10", "17", "18", "31", "32", "39", "40", "47", "48"];  //木
    var wuxs = ["07", "08", "15", "16", "23", "24", "37", "38", "45", "46"];        //水
    var wuxh = ["03", "04", "11", "12", "25", "26", "33", "34", "41", "42"];    //火
    var wuxt = ["13", "14", "21", "22", "29", "30", "43", "44"];        //土
    var wuxings = { "J": { name: "金", list: wuxj }, "M": { name: "木", list: wuxm }, "S": { name: "水", list: wuxs }, "H": { name: "火", list: wuxh }, "T": { name: "土", list: wuxt } };

    var shengXiaoNameNow = 'AC';   //*****当前生肖
    var shengXiaoNames = {
