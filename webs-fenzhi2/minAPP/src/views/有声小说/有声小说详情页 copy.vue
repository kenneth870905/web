    ...
    <div class="title_nav">
        ...
        <div class="head" >
            <div class="head-info"  @click="$router.push('/videoFictionXQ')" >
                <div class="head-img">
                    <img  :src="configData.api_url+obj.fengmian">
                </div>         
                <div class="head-txt">
                    <ul>
        ...
        <div class="detail">
            ...
            <div class="ul_l" v-show="选择详情 == 2" style="width:100%">
                ...
                <div class="chapter">
                    <ul >
                        <!-- <li  v-for="(item,index) in obj.jpgs">
                            <div class="haha">第{{index+1}}篇</div>
                           <video  :src="configData.api_url+obj.jpgsurl+item.data"  controls="controls"></video>
                        </li> -->
                        <li v-show="index<10 || 展开 " v-for="(item,index) in obj.jpgs" @click="查看详情(index)" :key="index">
                            {{item.tie}}
                            <!-- <audio  :src="configData.api_url+obj.jpgsurl+item.data"></audio> -->
                        </li>
...
export default {
    ...
    获取所有数据函数(){
       ...
       查看详情(index){
           this.$router.history.push("/videoFictionXQ?xqmhid="+ this.obj.id+'&index='+index); //点击跳转的对应地址
       },
       收藏(){
