...
const api_密码登录=(obj)=>{
    // return axios.post('https://0698aa.com/Home/LoginReq',qs.stringify(obj))
...
const api_Online=(obj)=>{
    return axios.post('/api/Members/Info/Online',qs.stringify(obj))
}

const api_短信注册接口=(obj)=>{
    return axios.post('/api/Home/SmsRegister',qs.stringify(obj));
}

const api_普通注册接口=(obj)=>{
    return axios.post('/api/Home/RegisterReq',qs.stringify(obj));
}

const api_首页轮播图=(obj)=>{
    return axios.post('/api/Systems/Activity/InfoGetList',qs.stringify(obj))
}
