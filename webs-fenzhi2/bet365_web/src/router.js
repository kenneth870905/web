...
export default new Router({
  routes: [
    ...
    },
    {
      path: '/grziliao',
      name: 'grziliao',
      component: () => import('./pages/my/grziliao/grziliao.vue')// 个人资料
    },
    {
      path: '/grxinxi',
      name: 'grxinxi',
      component: () => import('./pages/my/grziliao/grxinxi.vue')// 个人信息
    },
    {
      path: '/xgnicheng',
      name: 'xgnicheng',
      component: () => import('./pages/my/grziliao/xgnicheng.vue')// 修改昵称
    },
    {
      path: '/aqwenti',
      name: 'aqwenti',
      component: () => import('./pages/my/grziliao/aqwenti.vue')// 安全问题
    },
    {
      path: '/yhkxinxi',
      name: 'yhkxinxi',
      component: () => import('./pages/my/grziliao/yhkxinxi.vue')// 银行卡信息
    },
    {
      path: '/dlmima',
      name: 'dlmima',
      component: () => import('./pages/my/grziliao/dlmima.vue')// 修改登录密码
    },
    {
      path: '/aqmima',
      name: 'aqmima',
      component: () => import('./pages/my/grziliao/aqmima.vue')// 修改安全密码
    },
    {
      path: '/tzjilu',
      name: 'tzjilu',
    ...
    },
    {
      path: '/kfzhongxin',
      name: 'kfzhongxin',
      component: () => import('./pages/my/kefu/kfzhongxin.vue')// 客服中心
    },
    {
      path: "*",
      name: "",
    ...
    },
    {
      path: "/qpiframe",
      name: "qpiframe",
      component: () => import('@/components/qpiframe.vue'), 
      meta: {
        需要登录: true,
      }
    },
    ...
    {
      path:"/xtshezhi",
      component:()=>import('@/pages/my/xtshezhi/xtshezhi.vue'),
    },
    {
      path:"/yijian",
      component:()=>import('@/pages/my/yijian/yijian.vue'),
    },
    {
      path:"/tianjiayijian",
      component:()=>import('@/pages/my/yijian/tianjiayijian.vue'),
    },
    {
      path:"/jihua",
      component:()=>import('@/pages/jihua/jihua.vue'),
    },
  ]
})
