        ...
        <div class="mui-content mui-fullscreen" :class="{'active':img}">
            ...
            <div class="box_2">
                ...
                <div class="头像集">
                    ...
                    <ul>
                        <li v-for="(item, index) in 10" :key="index">
                            <img @click="设置图片('GL'+item+'.png')" :src="config.img_url+'image/touxiang/Gl'+item+'.png'" alt="">
                        </li>
                    </ul>
                </div>
                <div class="头像集">
                    ...
                    <ul>
                        <li v-for="(item, index) in 6" :key="index">
                            <img @click="设置图片('GLJL'+item+'.png')" :src="config.img_url+'image/touxiang/GLJL'+item+'.png'" alt="">
                        </li>
                    </ul>
                </div>
            </div>
