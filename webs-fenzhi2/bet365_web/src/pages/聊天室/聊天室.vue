            ...
            <!-- <div class="底部" ref="底部输入框"> -->
                ...
                <ul class="列表1" v-if="显示自定义添加">
                    ...
                    <li @click="$toast('暂未开放')">
                     ...
                     <li @click="$router.push('/jihua')">
                        <div><i><img src="image/liaotian/icon-jh.jpg" style="width:40px;height:40px;margin-top:5px;"></i></div>
                        <div>计划</div>
                    </li>
                    <li class="换行"></li>
                    <li @click="显示选择彩票=true">
                        <div>
                            <i><img src="image/liaotian/icon-cai.png" style="width:40px;height:40px;margin-top:5px;"></i>
                        </div>
                        <div>彩票</div>
                    </li>
                    <li @click="$router.push('/tzjilu?back=1&state=1')">
                        <div>
                            <i> <img src="image/liaotian/icon-zhudan.png" style="width:45px;height:40px;border-radius: 50%;margin-top:5px;"> </i>
                        </div>
                        <div>注单</div>
                    </li>
                    <li @click="$router.push('/chongzhi')">
                        <div>
                            <i > <img src="image/liaotian/icon-chongzhi.jpg" style="width:37px;height:37px;margin-top:5px;">  </i>
                        </div>
                        <div>充值</div>
                    </li>
                    <li @click="$router.push('/tixian')">
                        <div>
                            <i>  <img src="image/liaotian/icon-tixian.png" style="width:32px;height:32px;margin-top:5px;"> </i>
                        </div>
                        <div>提现</div>
                    </li>
                    <!-- <li @click="$toast('暂未开放')">
...
export default {
    ...
    watch: {
        msglist() {
            console.log('msglist',this.到达底部)
            this.$nextTick(() => {
                if (this.到达底部) {
                    // this.$refs.内容列表.querySelector('.内容列表>li:last-child').scrollIntoView({ 'behavior': 'smooth', block: 'start' })
                    this.$refs.内容列表.querySelector('.内容列表>li:last-child').scrollIntoView({ block: 'start' })
                    if(!this.msglist[this.msglist.length-1]){
                        return
                    }
                    let type=''
                        if(this.第一次){
                    ...
                    if(this.msglist[this.msglist.length-1].Type==4){
                        setTimeout(() => {
