    ...
    <li class="item left" :class="type">
        <div  class="img_box">
            ...
            <template v-if="obj.MemberId=='计划员'">
                <img v-if="obj.ImgId" :src="config.img_url+'image/touxiang/'+obj.ImgId">                
                <img v-else  :src="config.img_url+'image/touxiang/GLJL1.png'">                
            </template>
        ...
        <div class="cont">
            ...
            <div class="msg">
                <div class="一键计划">
                    <div class="header_1">
                        <img :src="config.img_url+'image/liaotian/follow-bg.png'">
                    </div>
                    ...
                    <div class="text2" v-if="contentObj">
                        ...
                        <ul>
                            <li class="item_1" v-for="(item, index) in contentObj.Data" :key="index">
                                <div class="">
                                    <!-- <div>{{item.IssueCode.substring(item.IssueCode.item.IssueCode-3)}}期</div> -->
