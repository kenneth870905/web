<template>
    <div class="mint-tab-container-item lottery-intro wfgz-content">
        ...
        <div class="intro">
            <div class="topic">
                <i class="icon iconfont icon-wenben"></i>玩法简介
            </div>
            <div class="list">
                <div class="item">
                    <span>1.</span>
            ...
            <div class="list">
                <div class="item">
                    <span>4.</span>
                    <p>
                        组选：将投注号码的所有排列方式作为一注投注号码进行投注，即号码顺序不限，开奖号中包含投注号码则中奖。示例：前三组选01 02 03，排列方式有01 02 03、01 03 02、02 01
                        03、02 03 01、03 01 02、03 02 01，共计6种。
                    </p>
                </div>
            </div>
        </div>
