        ...
        <div class="mui-content">
            <ul class="list">
                <li class="" v-if="item.彩票详情" @click="$router.push('/kjzs?id='+key)" v-for="(item , key , index) in list" :key="index">
                    <div class="img_box">
                        <img :src="config.img_url+'image/home/caipiao/'+key+'.png'" alt="" srcset="">
                    </div>
                    <div class="right_1">
                        <div class="标题">
                        ...
                        <div class="期号">
                            ...
                            <i class="van-icon van-icon-arrow" style="float:right;margin-right:10px;font-size:18px;color:#868484;"></i>
                        </div>
                        <div>
