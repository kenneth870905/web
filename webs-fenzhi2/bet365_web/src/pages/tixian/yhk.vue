<template>
    <div>
        ...
        <div class="mui-content mui-fullscreen">
            ...
            <ul class="list">
                <li class="item" @click="点击默认()" v-if="银行卡.currentBank.Bank" :style="{'background-image':'url('+config.img_url+'image/daili.png)'}">
                    <div class="icon_box">
                ...
                <li class="item" v-for="(item, index) in 银行卡.otherBanks" :key="index" @click="$router.push('/yhksz?id='+item.Id)" :style="{'background-image':'url('+config.img_url+'image/daili.png)'}">
                    <div class="icon_box">
                        <i > <img style="width:35px;height:22px; " src="image/my/icon-yhk.png" alt=""> </i>
                    </div>
                    <div>
