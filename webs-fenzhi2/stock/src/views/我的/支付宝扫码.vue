<template>
    <div class="wechat">
        <van-nav-bar title="支付宝扫码" left-arrow :fixed="true" @click-left="onClickLeft"/>
          <div class="wechat_content">
            <div class="code_img">
                ...
                <p class="code_title">扫一扫二维码完成支付宝转账</p>
            </div>
            ...
            <!-- <p class="p_title"><span>收款人:&nbsp;</span>{{objdata.bankAccount}}</p> -->

             <div class="bottom">
                <p class="title_p_text"> {{objdata.describe}}</p>
            </div>
    ...
    data() {
     ...
     created(){
      ...
      var dataAll= x.data.data
       this.objdata= dataAll.find(x => x.payTypeText == "支付宝扫码")
