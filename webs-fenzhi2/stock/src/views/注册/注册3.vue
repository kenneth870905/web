            ...
            <ul class="输入框">
              <li class="item_baba">
               <div class="name_box"><span class="fred">*</span>&nbsp;账户名:</div>
                <div class="item">
                    <input v-model="user.uid" type="text" placeholder="请输入用户名" @keyup.enter="注册()"/>
                 ...
                 <li class="item_baba"  v-if="!isphone">
                  <div class="name_box"><span cla        ss="fred">*</span>&nbsp;密码:</div>
                    <div class="item">
                        <input v-model="user.pwd"  @keyup.enter="注册()" :type="查看密码 ? 'text' : 'password'" placeholder="请输入密码" />
                        <!-- <div class="眼睛"> -->
                  ...
                  <li class="item_baba" v-if="!isphone">
                    <div class="name_box"><span class="fred">*</span>&nbsp;确认密码:</div>
                      <div  class="item">
                          <input v-model="user.pwd1"  @keyup.enter="注册()" :type="查看密码1 ? 'text' : 'password'" placeholder="请输入确认密码" />
                          <!-- <div class="眼睛">
                  ...
                  <li class="item_baba"  v-if="!isphone">
                    <div class="name_box"><span class="fred">*</span>&nbsp;推荐人ID</div>
                      <div class="item">
                          <input type="text" v-model="user.ruid" @keyup.enter="注册()" placeholder="请输入邀请码（选填）">
                      </div>
                  </li>
                  ...
                  <li class="item_baba" v-if="!isphone">
                    ...
                    <div  class="item imgCode">
                        <input type="text" v-model="user.code" @focus="focus1" @keyup.enter="注册()" placeholder="请输入验证码">
                      </div>
                 ...
                 <li class="item_baba" v-if="isphone">
                      ...
                      <div  class="item imgCode">
                          ...
                          <input type="text" @keyup.enter="注册()" v-model="user.sms" placeholder="请输入验证码">
