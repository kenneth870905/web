  ...
  <div class="登录">
     ...
     <!-- ============弹出框============================= --> 
      ...
      <div class="title">
        ...
        <div class="content">
            <div class="引导">
                <span class="zhis">{{ 密码或验证登陆==true ? "短信验证登陆" : "密码验证登陆"}}</span><span class="min_yd" @click="$router.push('/register')">去注册</span>
            </div>
             <div  class="账号" >
                 <div class="left">
             ...
             <div  class="text">
              ...
              <div class="login_btn" @click="登陆()">登陆</div>
...
<script>
import {登陆,获取验证码} from "@/api/登陆注册.js"
