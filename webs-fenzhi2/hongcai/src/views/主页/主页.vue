    ...
    <div class="主页">
      ...
      <div class="title">
        ...
        <div class="上半段">
            ...
            <div class="选项卡">
                <div class="更多" @click="更多()"><span class="text">更多</span><span class="icon">
                 <van-icon name="arrow" /></span></div>
                   <!-- <div class="明星" >
                        <ul class="ul_c">
                            <li  v-for="(keey,indexs) in item.minlist"> </li>
                   ...
                   <van-tabs v-model="active" animated class="明星"   @click="onClick">
                    <van-tab title="足球"  v-for="(item,index) in 专家列表数据" :title="item.title">
                        <ul class="ul_c">
                            <li  v-for="(keey,indexs) in item.minlist"  v-show="indexs<8"   @click="查看专家详情(keey)" >
                                <div>
                                    <div class="img_box"><img :src="configData.api_url+keey.head" alt=""></div>
                                    <div class="name">{{keey.name}}</div>
                                </div>
                                <div class="定位火" v-if="keey.ishot==1"><span class="iconfont iconfenlei-remen"></span></div>
                            </li>
                        </ul>
                    </van-tab>
                </van-tabs>
            ...
            <div class="content_c">
                <ul class="top">
                    <li v-for="(item,index) in Allobj.JingXuan" @click="赛事详情(item)">
                        <div class="右上角">精选</div>
                        <div class="title_bt"><span>[{{item.typeid==0?'足':'篮'}}] </span>
                            <span   v-if="item.status==0">未开始</span>
                            <span v-if="item.status==1">进行中</span>
                            <span v-if="item.status==2">延期</span>
             ...
             <ul class="顶部固定_titile" >
                <li @click="clicktite(0)" :class="{'titleActive':tableType ==0}">全部</li>
                 ...
                 <li  @click="clicktite(1)" :class="{'titleActive':tableType ==1}">
                    <span>分类&nbsp;</span> <span class="iconfont" :class="zhuqshow==true ? 'iconxiangshang' : 'iconxiangxia'"></span>
                 </li>
