        ...
        <div class="div_box" :style="{'background-image':'url('+皮肤区分.registerimg+')'}">
         <div class="dalete_box"  @click="点我关闭登陆框()"><img :src="皮肤区分.delete" alt=""></div>
            ...
            <div class="contentbai"  :class="皮肤区分.classname" >
               <div class="test">
                   <div @click="返回登陆框()"><span class="iconfont iconzuobian"></span></div>
                   <div class="wj_title">忘记密码</div>
                   <div @click="注册()">注册</div>
                </div> 
                 ...
                 <div class="login_btn" @click="确认()">确认</div>
            </div>
        </div>
 ...
 export default {
    data() {
        return {
            ...
            TSinvite:"",
            bai:{
               registerimg:require("../../assets/img/qit/bai/pwdbj.png"),
            ...
            hei:{
                registerimg:require("../../assets/img/qit/hei/pwdbj.png"),
    ...
    methods: {
        ...
        确认(){
            ...
            if (this.register.phone==""){//手机号码正确 phoneYZ
                   Toast("请输入手机号码"); 
                  return
            }
       ...
       .contentbai{
           ...
           .账号{
            ...
            .test{
             ...
             padding:_vw(14) _vw(10) _vw(14) _vw(0);
             align-items: center;
             .wj_title{
                 font-size: _vw(22)
             }
