    ...
    <div class="主页">
       ...
       <div class="content" :style="{'background-color':皮肤区分.backg}" >
              <div class="轮播">
                ...
                <div class="购彩资讯">
                    <img v-if="皮肤切换" @click="首页类型切换()"  :src=" honmeT ? bai.lefimgzx : bai.leftimggc" alt>
                    <img  v-if="!皮肤切换"  @click="首页类型切换()"  :src="!honmeT ? hei.lefimgzx : hei.leftimggc" alt>
               </div>
                 <div class="换肤">
...
export default {
    data() {
        return {
          honmeT:true,//购彩资讯切换
            banner: [
                {
                  img:require('../../assets/img/home/banner1.jpg'),
                  id:1
                 ...
                 {
                   img:require('../../assets/img/home/banner4.jpg'),
                   id:4
                },
    ...
    methods: {
      ...mapMutations({
        ...
        go轮播(item){
            // this.$router.history.push(item.id); //点击跳转的对应地址
        }
      },
        mounted() {
