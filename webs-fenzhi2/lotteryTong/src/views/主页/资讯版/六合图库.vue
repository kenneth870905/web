    ...
    <div class="六合图库">
        ...
        <div v-if="shouTP" >
           <div class="投票弹出框" v-for="(item,index) in list" v-if="indexs == index" :key="index">
               ...
               <div class="tijiao_btn" @click="shouTP=false">提交</div>  
           </div>
        </div>
        ...
        <div class="评论" :style="{'background':皮肤区分.topbj}">
            <div class="input" >
                <div class="left_input">
                    <van-cell-group>
                    <van-field v-model="value" placeholder="请输入评论内容，25字以内" />
                    </van-cell-group>
                </div>
       ...
       <div class="投注"  @click="$router.history.push('/buyLottery')"><img src="@/assets/img/bxtj/betting.6320e08.png" alt=""></div>
        ...
        <div class="content">
            ...
            <div class="right_div" v-for="(item,index) in list" v-if="indexs == index" :key="index">
                <!-- <div class="期数">
                    <div class="btn_q">上一期</div>
                    <div class="dangqian_q">2019104</div>
                </div>
                 ...
                 <div class="图片切换">
                     ...
                     <div class="div_img"  v-if="tableType==0"><img src="@/assets/img/lhds/219e869d-3356-4e66-a3bd-b18201415264.jpg" alt=""></div>
                     <div class="div_img"  v-if="tableType==1"><img src="@/assets/img/lhds/dbfd858b-404c-48a2-96a9-057780d161c4.jpg" alt=""></div>
                 </div>
                <div class="div_img"><img src="@/assets/img/lhds/219e869d-3356-4e66-a3bd-b18201415264.jpg" alt=""></div>

                <ul class="票数">
                   <li>
                        <div class="type_T">猴</div>
                        <div class="jd"> <van-progress :show-pivot="false" color="#f44" :percentage="add" /></div>
                          ...
                          <li>
                           <div class="top_li">
                               <div class="li_left_top">
                                   <div class="toux"><img src="@/assets/img/lhds/girl.c5b1ff4.jpg" alt=""></div>
                                   <span class="name">李寻欢龙</span>
                               </div>
                               <div class="li_right_top">2019-09-07 14:32:09</div>
                           </div>
                           <div class="bottom_li">评论区文字文字评论区文字文字评论区文字文字</div>
                          </li>
                           <li>
                           <div class="top_li">
                               <div class="li_left_top">
                ...
                <!-- <div v-for="(item,index) in list" v-if="indexs == index" :key="index">{{item.期号}}</div> -->


                     <div class="期数">
                        <div class="btn_q" @click="上一期(item)">上一期</div>
                        <div class="dangqian_q">{{item.期号}}</div>
                 </div>
                ...
                <div class="投票按钮" @click="投票()">投票</div>
                  ...
                  <div class="评论区">
                      ...
                      <ul class="pl_ul">
                          <li  v-for="(item2,index) in item.评论">
                           <div class="top_li">
                               <div class="li_left_top">
                                   <div class="toux"><img src="@/assets/img/lhds/girl.c5b1ff4.jpg" alt=""></div>
