...
var ajaxFun = new function(){
	...
	this.send = function(url,data,eventFun,option){
		...
		}).always(eve.always).fail(function(e){eve.fail(e)}).done(function(rt){
			eve.done(rt)
		})
	}
}
...
function GetDateInf(Day){
	...
	DateInf['Y'] = y;DateInf['n'] = n;DateInf['m'] = m;DateInf['d'] = d;DateInf['w'] = w;
	DateInf['H'] = H;DateInf['i'] = i;DateInf['s'] = s;
	return DateInf;
}