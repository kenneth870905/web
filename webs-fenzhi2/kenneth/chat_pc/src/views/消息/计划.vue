<template>
    <li class="item left" :class="type">
        <div  class="img_box">
            <img v-if="obj.MemberId!='计划员'" :src="config.img_url+'static/image/touxiang/'+obj.ImgId">
            <img v-if="obj.MemberId=='计划员'" src="static/image/kefu.png" alt="" srcset="">
        </div>
        <div class="cont">
            ...
            <div class="msg">
                <div class="一键计划">
                    <div class="header_1">
                        <img src="static/image/liaotian/follow-bg.png">
                    </div>
                    ...
                    <div class="text2" v-if="contentObj">
                        ...
                        <ul>
                            <li class="item_1" v-for="(item, index) in contentObj.Data" :key="index">
                                <div class="">
                                    <div>
                                        ...
                                        <!-- {{item.IssueCode.substring(item.IssueCode.length-3)}}期 -->
                                        期
                                    </div>
...
export default {
    ...
    methods: {
        ...
        async 跟投(){
            ...
            // var l =  this.contentObj.Data[this.contentObj.Data.length-1]
