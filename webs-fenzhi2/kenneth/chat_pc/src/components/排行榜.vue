<template>
    ...
    <el-dialog title="" :visible.sync="聊天室state.显示排行榜" width="450px">
        <div class="排行榜">
            <div class="内容">
                <div class="btn_list">
                    <el-button-group>
                        <el-button @click="type=0" size="mini" type="primary" :plain="type!=0">昨日充值排行榜</el-button>
                        <el-button @click="type=1" size="mini" type="primary" :plain="type!=1">昨日盈利排行榜</el-button>
                    </el-button-group>
                </div>
                ...
                <!-- <div class="title_1">
                    ...
                    <i @click="设置key(['显示排行榜',false])" class="icon iconfont icon-guanbi 关闭"></i>
                </div> -->
                <div class="list">
                    <ul v-if="type==0">
                        <li v-for="(item, index) in 入款排行" :key="index">
                            <!-- <div class="img_box">
                                <img :src="'static/image/touxiang/'+img[index]" alt="" srcset="">
                            </div> -->
                            <div class="text_1">
                                <div>
                            ...
                            <div class="排名">
                                <i v-if="index<3" :class="{金牌:index==0,银牌:index==1,铜牌:index==2}" class="icon iconfont icon-zhongjiangliebiao"></i>
                                <div v-if="index>=3">
                                    {{index+1}}
                                </div>
                            </div>
                    ...
                    <ul v-if="type==1">
                        <li v-for="(item, index) in 盈利排行" :key="index">
                            <!-- <div class="img_box">
                                <img :src="'static/image/touxiang/'+img1[index]" alt="" srcset="">
                            </div> -->
                            <div class="text_1">
                                <div>
                                    会员账号：<span class="昵称">{{item.MemberId}}</span>
