    ...
    <div>
        ...
        <div class="mui-content mui-fullscreen" :class="{'弹出键盘':showKeyboard}">
            <div class="转出金额">
                ...
                <div class="title">当前收益: <span class="红色">{{profit.TodayProfit}}</span> </div>
                
                <div class="title">{{type1==1 ? '转入' : "转出"}}金额(元)</div>
                <ul>
                    <li class="钱">￥</li>
                    <input v-model="obj.model.Money" type="text" :placeholder="type1==1 ? '请输入转入金额':'本次最大可转出'+profit.Amount">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <i @click="切换类型()" :class="{'icon-yanjing':type=='password','icon-yanjing1':type!='password'}" class="icon iconfont icon-yanjing"></i>
                    </li>
                </ul>
            </div>
            <div class="提示">
