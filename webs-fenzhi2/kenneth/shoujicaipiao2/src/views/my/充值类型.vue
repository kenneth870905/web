        ...
        <div class="mui-content mui-fullscreen">
            ...
            <ul class="mui-table-view 个人信息">
                <li class="mui-table-view-cell mui-media">
                    <!-- <a href="javascript:;"> -->
                        <i class="mui-media-object mui-pull-left icon iconfont icon-touxiang"></i>
            ...
            <div class="title_1" v-show="充值类型.Online.length>0">在线支付 Online Payment<span>（推荐使用）</span></div>
            <ul class="mui-table-view 充值方式">
                <li class="mui-table-view-cell"  @click="跳转选卡(item)" v-for="(item, index) in 充值类型.Online" :key="index">
                    <a class="mui-navigate-right item">
                        <img :src="config.img_url+'static/image/zhifu/'+item.Id+'.png'" alt="">
                        <span>{{item.Title}}</span>
                    </a>
                </li>
            </ul>
            <div class="title_1" v-show="充值类型.Transfer.length>0">手机转账 Mobile transfer </div>
            <ul class="mui-table-view 充值方式">
