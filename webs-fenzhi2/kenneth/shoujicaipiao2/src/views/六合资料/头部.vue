    ...
    <ul class="开奖头部">
        <li>
            <div class="近期" @click="显示最近记录=!显示最近记录">
                <img class="logo_1" :src="config.img_url+'static/image/home/caipiao/70001.png'">
                <div>近期开奖</div>
        ...
        <div class="红包" @click="$router.push('/ifr/liuheHongbao')">
...
<script>
import { api_获取近期开奖 } from "@/api/游戏彩票接口.js";
    ...
    methods: {
        ...
        初始化() {
            ...
            api_获取近期开奖(query).then(x => {
                this.近期开奖 = x.data.Top5
            }).catch(err => { })
            var query_1 = {
                lotteryCode: 70001,
                state: 0
            }
            api_获取近期开奖(query_1).then(x => {
                var data = x.data
