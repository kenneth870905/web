<template>
    <div class="最新中奖" :class="class1" v-show="显示最新中奖">
        <div class="img_0">
            <img :src="config.img_url+'static/image/liaotian/zhongjiang.png'" alt="" srcset="">
        </div>
        <div class="img_1">
            <img :src="config.img_url+'static/image/liaotian/zhongjiang1.png'" alt="" srcset="">
        </div>
        <div class="text_1">
            恭喜
        ...
        <div class="img_2">
            <img :src="config.img_url+'static/image/liaotian/zhongjiang2.png'" alt="" srcset="">
        </div>
