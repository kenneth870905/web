...
export default {
    ...
    computed: {
        ...
        长龙统计(){
            var list=[
                {name:"第一球",大小:true,大:0,小:0,单双:true,单:0,双:0},
                {name:"第二球",大小:true,大:0,小:0,单双:true,单:0,双:0},
                {name:"第三球",大小:true,大:0,小:0,单双:true,单:0,双:0},
                {name:"第四球",大小:true,大:0,小:0,单双:true,单:0,双:0},
                {name:"第五球",大小:true,大:0,小:0,单双:true,单:0,双:0},
                {name:"和值" , 大小:true,大:0,小:0,单双:true,单:0,双:0},
            ]
            var 未开奖次数=0;
