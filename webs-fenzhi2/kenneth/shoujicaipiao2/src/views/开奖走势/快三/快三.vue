            ...
            for (let i = this.开奖记录.length-1; i >= 0; i--) {
                ...
                if(开奖走势1.length>0){
                    obj.list=[
                        ...
                        {number: 开奖号[this.走势查看]==2 ? 2 : '' , 累计: 开奖号[this.走势查看]==2 ? 0 : 开奖走势1[0].list[1].累计+1},
                        {number: 开奖号[this.走势查看]==3 ? 3 : '' , 累计: 开奖号[this.走势查看]==3 ? 0 : 开奖走势1[0].list[2].累计+1},
                        {number: 开奖号[this.走势查看]==4 ? 4 : '' , 累计: 开奖号[this.走势查看]==4 ? 0 : 开奖走势1[0].list[3].累计+1},
                        {number: 开奖号[this.走势查看]==5 ? 5 : '' , 累计: 开奖号[this.走势查看]==5 ? 0 : 开奖走势1[0].list[4].累计+1},
                        {number: 开奖号[this.走势查看]==6 ? 6 : '' , 累计: 开奖号[this.走势查看]==6 ? 0 : 开奖走势1[0].list[5].累计+1},
                    ]
                    出现次数=[
