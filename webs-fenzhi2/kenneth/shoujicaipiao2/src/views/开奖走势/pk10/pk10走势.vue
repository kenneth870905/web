<template>
    <div class="走势内容">
        <div class="头部">
            <ul class="title_1" ref="title_1">
                <li :class="{'active':走势查看==0}" @tap="走势查看=0">第一名</li>
                <li :class="{'active':走势查看==1}" @tap="走势查看=1">第二名</li>
                <li :class="{'active':走势查看==2}" @tap="走势查看=2">第三名</li>
                <li :class="{'active':走势查看==3}" @tap="走势查看=3">第四名</li>
                <li :class="{'active':走势查看==4}" @tap="走势查看=4">第五名</li>
                <li :class="{'active':走势查看==5}" @tap="走势查看=5">第六名</li>
                <li :class="{'active':走势查看==6}" @tap="走势查看=6">第七名</li>
                <li :class="{'active':走势查看==7}" @tap="走势查看=7">第八名</li>
                <li :class="{'active':走势查看==8}" @tap="走势查看=8">第九名</li>
                <li :class="{'active':走势查看==9}" @tap="走势查看=9">第十名</li>
            </ul>
        </div>
        <ul class="走势列表">
            <li class="header">
...
export default {
    ...
    watch: {
        走势查看(){
            ...
            this.$nextTick(()=>{
                this.$refs.title_1.querySelector('.active').scrollIntoView({'behavior':'smooth',inline:'center'})
            })
        }
    },
}
