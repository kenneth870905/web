        ...
        <li>
            ...
            <ul class="上期开奖">
                <li v-if="近期开奖.length>0 && 近期开奖[0].Content && 近期开奖[0].Content.length>0">
                    <span class="圆球" v-for="(item, index) in 近期开奖[0].Content" :key="index">{{item}}</span>
                </li>
                <li v-else class="红色">
                    <div class="开奖中">
                        开奖中...
            ...
            <ul>
                ...
                <li class="item" v-for="(item, index) in 近期开奖" :key="index">
                    ...
                    <div v-if="item.Content" class="开奖号2">
                        <span class="圆球" v-for="(item1, index1) in item.Content" :key="index1">{{item1}}</span>
                    </div>
                    <div v-if="item.Content" class="大小 font14">{{计算大小(item.Content)}}</div>
                    <div v-if="item.Content" class="单双 font14">{{计算跨度(item.Content)}}</div>
