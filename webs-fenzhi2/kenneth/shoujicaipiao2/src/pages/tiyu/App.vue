<template>
    ...
    <div id="app" ref="app" @touchstart="触碰屏幕($event)" @touchend="手指头离开屏幕($event)" :class="appClass">
        ...
        <router-view ref="nav" class="nav" name="nav" ></router-view>
...
export default {
    ...
    mounted() {
        if(!this.偏好设置.主题色.color){
            this.偏好设置.主题色 = {img:config.img_url+"static/image/my/zhuti_9.png",color:"#333333",name:"优雅黑"}
        }

        console.log('tiyu app.vue')
        var this_1=this;
        // smoothScrollTo
        // scrollTo
        // scrollIntoView 
