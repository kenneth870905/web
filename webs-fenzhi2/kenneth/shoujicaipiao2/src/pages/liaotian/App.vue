...
export default {
    ...
    methods: {
        ...
        路由变化(){
            ...
            // /chat/contactsList   通讯录
            
            var path=this.$route.path;
            
            // 取消获取消息列表
            var url1 = [
                    '/','/home/home','/yxdt','/orders','/discovery','/my','/chatBoxes','/chatlist',
                    '/chat/messageList','/chat/contactsList'
                ];
            ...
            //获取好友请求验证
            var url2 = [ '/','/home/home','/my',
                    '/chat/messageList','/chat/contactsList'
                ];
            var path=this.$route.path;
            if(url2.includes(path)){
                setTimeout(() => {
                    this.获取验证请求()
                }, 3000);
            }else{
