<template>
    <div class="悬浮按钮"  :class="{'展开':展开,'收起':!展开}">
        ...
        <div class="圆圈" ref="悬浮按钮" :class="{'回弹':!移动中,'靠左':!靠右}" :style="{'top':y+'px','left':x+'px'}" @click="展开=!展开" @touchstart="圆心开始拖动($event)" @touchmove.prevent="圆心滑动中($event)" @touchend="圆心手指离开()">
            ...
            <ul class="list">
                <li class="item_0" @click="$router.push('/orders?back=1')">
                    <i class="icon iconfont icon-gouwuche"></i>
                    <div>注单</div>
                </li>
                <li class="item_1" @click="$router.push('/kjzs?id='+彩票id+'&zs=1')">
                    <i class="icon iconfont icon-64"></i>
                    <div>走势</div>
                </li>
                <li class="item_2" @click="$router.push('/kjzs?id='+彩票id)">
                    <i class="icon iconfont icon-zhongjiangliebiao"></i>
                    <div>开奖</div>
                </li>
                <li class="item_3" @click="$router.push('/my/chongzhi')">
                ...
                <li class="item_4" @click="$router.push(`/rule?i=${id}`)">
...
export default {
    ...
    methods: {
        ...
        圆心开始拖动(event){
            ...
            console.log(this.$refs.悬浮按钮.offsetLeft)
