...
class 投注40 extends 循环选号 {
    ...
    // 圆形选号
    设置选号_4(list,min,max,notitle){
        var OddKeys = this.玩法.OddKeys || {};
        let list1=[];
        let 选号1=[];
    ...
    get 球组() {
        ...
        if (this.玩法.Code == 1) {
            ...
            var list = [];
            list[1] = { name: "和值", style: '方形3', 选号: [] }
            list[0] = { name: "大小", style: '方形3', 选号: [] }
            for (let i = 3; i <= 18; i++) {
                list[1].选号.push({
                    code: 'ZH_' + i,
                    name: i,
